...
# print('Calcular Volume da Esfera')

# r = int(input('Digite o valor do raio da esfera: '))
# import math

# v = (4/3)*math.pi*r**3

# print('O volume total da esfera é: ',v)
# print('Fim do programa')
...
# v1 = int(input('Insira nota 1: '))
# v2 = int(input('Insira nota 2: '))
# v3 = int(input('Insira nota 3: '))

# media = (v1+v2+v3)/3

# print('A média aritimética de ', v1 ,'+', v2 ,'+', v3 , 'é: ',media)
# print('Fim do programa')
